...
import com.practice.main.service.QuizService;
...
public class QuizController {
	...
	QuizService quizService;
		@PostMapping("create")
		public ResponseEntity<String> createQuiz(@RequestParam String subtopic, @RequestParam int numQue, @RequestParam String title){
			return quizService.createQuiz(subtopic,numQue,title);
		}
		@GetMapping("get/{id}")
